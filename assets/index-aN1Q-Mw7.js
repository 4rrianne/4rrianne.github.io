...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fa(e,t,n){let r=new Float32Array(xa),i=new W(0,1,0);return new hi({name:`SphericalGaussianBlur`,defines:{n:xa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ra(),fragmentShader:`
	...
	`}var za=class extends zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ti(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new Ur(c,l),d=new Vi(-1,1,1,-1,0,1),f=null,p=null,m=!1,h,g=null,_=[],v=!1;this.setSize=function(e,t){o.setSize(e,t),s.setSize(e,t);for(let n=0;n<_.length;n++){let r=_[n];r.setSize&&r.setSize(e,t)}},this.setEffects=function(e){_=e,v=_.length>0&&_[0].isRenderPass===!0;let t=o.width,n=o.height;for(let e=0;e<_.length;e++){let r=_[e];r.setSize&&r.setSize(t,n)}},this.begin=function(e,t){if(m||e.toneMapping===0&&_.length===0)return!1;if(g=t,t!==null){let e=t.width,n=t.height;(o.width!==e||o.height!==n)&&this.setSize(e,n)}return v===!1&&e.setRenderTarget(o),h=e.toneMapping,e.toneMapping=0,!0},this.hasRenderPass=function(){return v},this.end=function(e,t){e.toneMapping=h,m=!0;let n=o,r=s;for(let i=0;i<_.length;i++){let a=_[i];if(a.enabled!==!1&&(a.render(e,r,n,t),a.needsSwap!==!1)){let e=n;n=r,r=e}}if(f!==e.outputColorSpace||p!==e.toneMapping){f=e.outputColorSpace,p=e.toneMapping,l.defines={},K.getTransfer(f)===`srgb`&&(l.defines.SRGB_TRANSFER=``);let t=qa[p];t&&(l.defines[t]=``),l.needsUpdate=!0}l.uniforms.tDiffuse.value=n.texture,e.setRenderTarget(g),e.render(u,d),g=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){o.depthTexture&&o.depthTexture.dispose(),o.dispose(),s.dispose(),c.dispose(),l.dispose()}}var Ya=new It,Xa=new ni(1,1),Za=new Bt,Qa=new Vt,$a=new ti,eo=[],to=[],no=new Float32Array(16),ro=new Float32Array(9),Y=new Float32Array(4);function io(e,t,n){let r=e[0];if(r<=0||r>0)return e;let i=t*n,a=eo[i];if(a===void 0&&(a=new Float32Array(i),eo[i]=a),t!==0){r.toArray(a,0);for(let r=1,i=0;r!==t;++r)i+=n,e[r].toArray(a,i)}return a}function X(e,t){if(e.length!==t.length)return!1;for(let n=0,r=e.length;n<r;n++)if(e[n]!==t[n])return!1;return!0}function ao(e,t){for(let n=0,r=t.length;n<r;n++)e[n]=t[n]}function oo(e,t){let n=to[t];n===void 0&&(n=new Int32Array(t),to[t]=n);for(let r=0;r!==t;++r)n[r]=e.allocateTextureUnit();return n}function so(e,t){let n=this.cache;n[0]!==t&&(e.uniform1f(this.addr,t),n[0]=t)}function co(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(X(n,t))return;e.uniform2fv(this.addr,t),ao(n,t)}}function lo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(e.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(X(n,t))return;e.uniform3fv(this.addr,t),ao(n,t)}}function uo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(X(n,t))return;e.uniform4fv(this.addr,t),ao(n,t)}}function fo(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(X(n,t))return;e.uniformMatrix2fv(this.addr,!1,t),ao(n,t)}else{if(X(n,r))return;Y.set(r),e.uniformMatrix2fv(this.addr,!1,Y),ao(n,r)}}function po(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(X(n,t))return;e.uniformMatrix3fv(this.addr,!1,t),ao(n,t)}else{if(X(n,r))return;ro.set(r),e.uniformMatrix3fv(this.addr,!1,ro),ao(n,r)}}function mo(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(X(n,t))return;e.uniformMatrix4fv(this.addr,!1,t),ao(n,t)}else{if(X(n,r))return;no.set(r),e.uniformMatrix4fv(this.addr,!1,no),ao(n,r)}}function ho(e,t){let n=this.cache;n[0]!==t&&(e.uniform1i(this.addr,t),n[0]=t)}function go(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(X(n,t))return;e.uniform2iv(this.addr,t),ao(n,t)}}function _o(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(X(n,t))return;e.uniform3iv(this.addr,t),ao(n,t)}}function vo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(X(n,t))return;e.uniform4iv(this.addr,t),ao(n,t)}}function yo(e,t){let n=this.cache;n[0]!==t&&(e.uniform1ui(this.addr,t),n[0]=t)}function bo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(X(n,t))return;e.uniform2uiv(this.addr,t),ao(n,t)}}function xo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(X(n,t))return;e.uniform3uiv(this.addr,t),ao(n,t)}}function So(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(X(n,t))return;e.uniform4uiv(this.addr,t),ao(n,t)}}function Co(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i);let a;this.type===e.SAMPLER_2D_SHADOW?(Xa.compareFunction=n.isReversedDepthBuffer()?518:515,a=Xa):a=Ya,n.setTexture2D(t||a,i)}function wo(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture3D(t||Qa,i)}function To(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTextureCube(t||$a,i)}function Eo(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture2DArray(t||Za,i)}function Do(e){switch(e){case 5126:return so;case 35664:return co;case 35665:return lo;case 35666:return uo;case 35674:return fo;case 35675:return po;case 35676:return mo;case 5124:case 35670:return ho;case 35667:case 35671:return go;case 35668:case 35672:return _o;case 35669:case 35673:return vo;case 5125:return yo;case 36294:return bo;case 36295:return xo;case 36296:return So;case 35678:case 36198:case 36298:case 36306:case 35682:return Co;case 35679:case 36299:case 36307:return wo;case 35680:case 36300:case 36308:case 36293:return To;case 36289:case 36303:case 36311:case 36292:return Eo}}function Oo(e,t){e.uniform1fv(this.addr,t)}function ko(e,t){let n=io(t,this.size,2);e.uniform2fv(this.addr,n)}function Ao(e,t){let n=io(t,this.size,3);e.uniform3fv(this.addr,n)}function jo(e,t){let n=io(t,this.size,4);e.uniform4fv(this.addr,n)}function Mo(e,t){let n=io(t,this.size,4);e.uniformMatrix2fv(this.addr,!1,n)}function No(e,t){let n=io(t,this.size,9);e.uniformMatrix3fv(this.addr,!1,n)}function Po(e,t){let n=io(t,this.size,16);e.uniformMatrix4fv(this.addr,!1,n)}function Fo(e,t){e.uniform1iv(this.addr,t)}function Io(e,t){e.uniform2iv(this.addr,t)}function Lo(e,t){e.uniform3iv(this.addr,t)}function Ro(e,t){e.uniform4iv(this.addr,t)}function zo(e,t){e.uniform1uiv(this.addr,t)}function Bo(e,t){e.uniform2uiv(this.addr,t)}function Vo(e,t){e.uniform3uiv(this.addr,t)}function Ho(e,t){e.uniform4uiv(this.addr,t)}function Uo(e,t,n){let r=this.cache,i=t.length,a=oo(n,i);X(r,a)||(e.uniform1iv(this.addr,a),ao(r,a));let o;o=this.type===e.SAMPLER_2D_SHADOW?Xa:Ya;for(let e=0;e!==i;++e)n.setTexture2D(t[e]||o,a[e])}function Wo(e,t,n){let r=this.cache,i=t.length,a=oo(n,i);X(r,a)||(e.uniform1iv(this.addr,a),ao(r,a));for(let e=0;e!==i;++e)n.setTexture3D(t[e]||Qa,a[e])}function Go(e,t,n){let r=this.cache,i=t.length,a=oo(n,i);X(r,a)||(e.uniform1iv(this.addr,a),ao(r,a));for(let e=0;e!==i;++e)n.setTextureCube(t[e]||$a,a[e])}function Ko(e,t,n){let r=this.cache,i=t.length,a=oo(n,i);X(r,a)||(e.uniform1iv(this.addr,a),ao(r,a));for(let e=0;e!==i;++e)n.setTexture2DArray(t[e]||Za,a[e])}function qo(e){switch(e){case 5126:return Oo;case 35664:return ko;case 35665:return Ao;case 35666:return jo;case 35674:return Mo;case 35675:return No;case 35676:return Po;case 5124:case 35670:return Fo;case 35667:case 35671:return Io;case 35668:case 35672:return Lo;case 35669:case 35673:return Ro;case 5125:return zo;case 36294:return Bo;case 36295:return Vo;case 36296:return Ho;case 35678:case 36198:case 36298:case 36306:case 35682:return Uo;case 35679:case 36299:case 36307:return Wo;case 35680:case 36300:case 36308:case 36293:return Go;case 36289:case 36303:case 36311:case 36292:return Ko}}var Jo=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Do(t.type)}},Yo=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=qo(t.type)}},Xo=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let r=this.seq;for(let i=0,a=r.length;i!==a;++i){let a=r[i];a.setValue(e,t[a.id],n)}}},Zo=/(\w+)(\])?(\[|\.)?/g;function Qo(e,t){e.seq.push(t),e.map[t.id]=t}function $o(e,t,n){let r=e.name,i=r.length;for(Zo.lastIndex=0;;){let a=Zo.exec(r),o=Zo.lastIndex,s=a[1],c=a[2]===`]`,l=a[3];if(c&&(s|=0),l===void 0||l===`[`&&o+2===i){Qo(n,l===void 0?new Jo(s,e,t):new Yo(s,e,t));break}{let e=n.map[s];e===void 0&&(e=new Xo(s),Qo(n,e)),n=e}}}var es=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){let n=e.getActiveUniform(t,r);$o(n,e.getUniformLocation(t,n.name),this)}let r=[],i=[];for(let t of this.seq)t.type===e.SAMPLER_2D_SHADOW||t.type===e.SAMPLER_CUBE_SHADOW||t.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(t):i.push(t);r.length>0&&(this.seq=r.concat(i))}setValue(e,t,n,r){let i=this.map[t];i!==void 0&&i.setValue(e,n,r)}setOptional(e,t,n){let r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let i=0,a=t.length;i!==a;++i){let a=t[i],o=n[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,r)}}static seqWithValue(e,t){let n=[];for(let r=0,i=e.length;r!==i;++r){let i=e[r];i.id in t&&n.push(i)}return n}};function ts(e,t,n){let r=e.createShader(t);return e.shaderSource(r,n),e.compileShader(r),r}var ns=37297,rs=0;function is(e,t){let n=e.split(`
`),r=[],i=Math.max(t-6,0),a=Math.min(t+6,n.length);for(let e=i;e<a;e++){let i=e+1;r.push(`${i===t?`>`:` `} ${i}: ${n[e]}`)}return r.join(`
`)}var as=new G;function os(e){K._getMatrix(as,K.workingColorSpace,e);let t=`mat3( ${as.elements.map(e=>e.toFixed(4))} )`;switch(K.getTransfer(e)){case Ye:return[t,`LinearTransferOETF`];case Xe:return[t,`sRGBTransferOETF`];default:return B(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function ss(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`
...
#endif
#include <dithering_fragment>
}`,qc=`uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}`,Jc=class extends hi{constructor(e,t,n,r,i=!1){super({name:`EffectMaterial`,defines:{THREE_REVISION:`185`.replace(/\D+/g,``),DEPTH_PACKING:`0`,ENCODE_OUTPUT:`1`},uniforms:{inputBuffer:new ia(null),depthBuffer:new ia(null),resolution:new ia(new U),texelSize:new ia(new U),cameraNear:new ia(.3),cameraFar:new ia(1e3),aspect:new ia(1),time:new ia(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,dithering:i}),e&&this.setShaderParts(e),t&&this.setDefines(t),n&&this.setUniforms(n),this.copyCameraSettings(r)}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(e){this.uniforms.depthBuffer.value=e}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(e){this.defines.DEPTH_PACKING=e.toFixed(0),this.needsUpdate=!0}setDepthBuffer(e,t=Ke){this.depthBuffer=e,this.depthPacking=t}setShaderData(e){this.setShaderParts(e.shaderParts),this.setDefines(e.defines),this.setUniforms(e.uniforms),this.setExtensions(e.extensions)}setShaderParts(e){return this.fragmentShader=Kc.replace(Rc.FRAGMENT_HEAD,e.get(Rc.FRAGMENT_HEAD)||``).replace(Rc.FRAGMENT_MAIN_UV,e.get(Rc.FRAGMENT_MAIN_UV)||``).replace(Rc.FRAGMENT_MAIN_IMAGE,e.get(Rc.FRAGMENT_MAIN_IMAGE)||``),this.vertexShader=qc.replace(Rc.VERTEX_HEAD,e.get(Rc.VERTEX_HEAD)||``).replace(Rc.VERTEX_MAIN_SUPPORT,e.get(Rc.VERTEX_MAIN_SUPPORT)||``),this.needsUpdate=!0,this}setDefines(e){for(let t of e.entries())this.defines[t[0]]=t[1];return this.needsUpdate=!0,this}setUniforms(e){for(let t of e.entries())this.uniforms[t[0]]=t[1];return this}setExtensions(e){this.extensions={};for(let t of e)this.extensions[t]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(e){this.encodeOutput!==e&&(e?this.defines.ENCODE_OUTPUT=`1`:delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(e){return this.encodeOutput}setOutputEncodingEnabled(e){this.encodeOutput=e}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}setDeltaTime(e){this.uniforms.time.value+=e}adoptCameraSettings(e){this.copyCameraSettings(e)}copyCameraSettings(e){e&&(this.uniforms.cameraNear.value=e.near,this.uniforms.cameraFar.value=e.far,e instanceof Bi?this.defines.PERSPECTIVE_CAMERA=`1`:delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(e,t){let n=this.uniforms;n.resolution.value.set(e,t),n.texelSize.value.set(1/e,1/t),n.aspect.value=e/t}static get Section(){return Rc}};Number(`185`.replace(/\D+/g,``));var Yc=255/256;new Float32Array([Yc/256**3,Yc/256**2,Yc/256,Yc]),new Float32Array([Yc,Yc/256,Yc/256**2,1/256**3]);function Xc(e,t,n){for(let r of t){let t=`$1`+e+r.charAt(0).toUpperCase()+r.slice(1),i=RegExp(`([^\\.])(\\b`+r+`\\b)`,`g`);for(let e of n.entries())e[1]!==null&&n.set(e[0],e[1].replace(i,t))}}function Zc(e,t,n){let r=t.getFragmentShader(),i=t.getVertexShader(),a=r!==void 0&&/mainImage/.test(r),o=r!==void 0&&/mainUv/.test(r);if(n.attributes|=t.getAttributes(),r===void 0)throw Error(`Missing fragment shader (${t.name})`);if(o&&(n.attributes&Lc.CONVOLUTION)!==0)throw Error(`Effects that transform UVs are incompatible with convolution effects (${t.name})`);if(!a&&!o)throw Error(`Could not find mainImage or mainUv function (${t.name})`);{let s=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,c=n.shaderParts,l=c.get(Rc.FRAGMENT_HEAD)||``,u=c.get(Rc.FRAGMENT_MAIN_UV)||``,d=c.get(Rc.FRAGMENT_MAIN_IMAGE)||``,f=c.get(Rc.VERTEX_HEAD)||``,p=c.get(Rc.VERTEX_MAIN_SUPPORT)||``,m=new Set,h=new Set;if(o&&(u+=`	${e}MainUv(UV);
`,n.uvTransformation=!0),i!==null&&/mainSupport/.test(i)){let t=/mainSupport *\([\w\s]*?uv\s*?\)/.test(i);p+=`	${e}MainSupport(`,p+=t?`vUv);
`:`);
`;for(let e of i.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(let t of e[1].split(/\s*,\s*/))n.varyings.add(t),m.add(t),h.add(t);for(let e of i.matchAll(s))h.add(e[1])}for(let e of r.matchAll(s))h.add(e[1]);for(let e of t.defines.keys())h.add(e.replace(/\([\w\s,]*\)/g,``));for(let e of t.uniforms.keys())h.add(e);h.delete(`while`),h.delete(`for`),h.delete(`if`),t.uniforms.forEach((t,r)=>n.uniforms.set(e+r.charAt(0).toUpperCase()+r.slice(1),t)),t.defines.forEach((t,r)=>n.defines.set(e+r.charAt(0).toUpperCase()+r.slice(1),t));let g=new Map([[`fragment`,r],[`vertex`,i]]);Xc(e,h,n.defines),Xc(e,h,g),r=g.get(`fragment`),i=g.get(`vertex`);let _=t.blendMode;if(n.blendModes.set(_.blendFunction,_),a){t.inputColorSpace!==null&&t.inputColorSpace!==n.colorSpace&&(d+=t.inputColorSpace===`srgb`?`color0 = sRGBTransferOETF(color0);
	`:`color0 = sRGBToLinear(color0);
	`),t.outputColorSpace===``?t.inputColorSpace!==null&&(n.colorSpace=t.inputColorSpace):n.colorSpace=t.outputColorSpace,d+=`${e}MainImage(color0, UV, `,(n.attributes&Lc.DEPTH)!==0&&/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/.test(r)&&(d+=`depth, `,n.readDepth=!0),d+=`color1);
...
`}if(l+=r+`
`,i!==null&&(f+=i+`
`),c.set(Rc.FRAGMENT_HEAD,l),c.set(Rc.FRAGMENT_MAIN_UV,u),c.set(Rc.FRAGMENT_MAIN_IMAGE,d),c.set(Rc.VERTEX_HEAD,f),c.set(Rc.VERTEX_MAIN_SUPPORT,p),t.extensions!==null)for(let e of t.extensions)n.extensions.add(e)}}var Qc=class extends wc{constructor(e,...t){super(`EffectPass`),this.fullscreenMaterial=new Jc(null,null,null,e),this.listener=e=>this.handleEvent(e),this.effects=[],this.setEffects(t),this.skipRendering=!1,this.minTime=1,this.maxTime=1/0,this.timeScale=1}set mainScene(e){for(let t of this.effects)t.mainScene=e}set mainCamera(e){this.fullscreenMaterial.copyCameraSettings(e);for(let t of this.effects)t.mainCamera=e}get encodeOutput(){return this.fullscreenMaterial.encodeOutput}set encodeOutput(e){this.fullscreenMaterial.encodeOutput=e}get dithering(){return this.fullscreenMaterial.dithering}set dithering(e){let t=this.fullscreenMaterial;t.dithering=e,t.needsUpdate=!0}setEffects(e){for(let e of this.effects)e.removeEventListener(`change`,this.listener);this.effects=e.sort((e,t)=>t.attributes-e.attributes);for(let e of this.effects)e.addEventListener(`change`,this.listener)}updateMaterial(){let e=new zc,t=0;for(let n of this.effects)if(n.blendMode.blendFunction===Z.DST)e.attributes|=n.getAttributes()&Lc.DEPTH;else if((e.attributes&n.getAttributes()&Lc.CONVOLUTION)!==0)throw Error(`Convolution effects cannot be merged (${n.name})`);else Zc(`e`+t++,n,e);let n=e.shaderParts.get(Rc.FRAGMENT_HEAD),r=e.shaderParts.get(Rc.FRAGMENT_MAIN_IMAGE),i=e.shaderParts.get(Rc.FRAGMENT_MAIN_UV),a=/\bblend\b/g;for(let t of e.blendModes.values())n+=t.getShaderCode().replace(a,`blend${t.blendFunction}`)+`
`;(e.attributes&Lc.DEPTH)===0?this.needsDepthTexture=!1:(e.readDepth&&(r=`float depth = readDepth(UV);
...
`+i,e.defines.set(`UV`,`transformedUv`)):e.defines.set(`UV`,`vUv`),e.shaderParts.set(Rc.FRAGMENT_HEAD,n),e.shaderParts.set(Rc.FRAGMENT_MAIN_IMAGE,r),e.shaderParts.set(Rc.FRAGMENT_MAIN_UV,i);for(let[t,n]of e.shaderParts)n!==null&&e.shaderParts.set(t,n.trim().replace(/^#/,`
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=Ke){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(let n of this.effects)n.setDepthTexture(e,t)}render(e,t,n,r,i){for(let n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){let i=this.fullscreenMaterial;i.inputBuffer=t.texture,i.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(let n of this.effects)n.setSize(e,t)}initialize(e,t,n){this.renderer=e;for(let r of this.effects)r.initialize(e,t,n);this.updateMaterial(),n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}dispose(){super.dispose();for(let e of this.effects)e.removeEventListener(`change`,this.listener),e.dispose()}handleEvent(e){e.type===`change`&&this.recompile()}};new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,-.25,.25,-.125,.125,-.375,.375]),new Float32Array([0,0]),new Float32Array([.25,-.25]),new Float32Array([-.25,.25]),new Float32Array([.125,-.125]),new Float32Array([-.125,.125]),new Uint8Array([0,0]),new Uint8Array([3,0]),new Uint8Array([0,3]),new Uint8Array([3,3]),new Uint8Array([1,0]),new Uint8Array([4,0]),new Uint8Array([1,3]),new Uint8Array([4,3]),new Uint8Array([0,1]),new Uint8Array([3,1]),new Uint8Array([0,4]),new Uint8Array([3,4]),new Uint8Array([1,1]),new Uint8Array([4,1]),new Uint8Array([1,4]),new Uint8Array([4,4]),new Uint8Array([0,0]),new Uint8Array([1,0]),new Uint8Array([0,2]),new Uint8Array([1,2]),new Uint8Array([2,0]),new Uint8Array([3,0]),new Uint8Array([2,2]),new Uint8Array([3,2]),new Uint8Array([0,1]),new Uint8Array([1,1]),new Uint8Array([0,3]),new Uint8Array([1,3]),new Uint8Array([2,1]),new Uint8Array([3,1]),new Uint8Array([2,3]),new Uint8Array([3,3]),el(0,0,0,0),new Float32Array([0,0,0,0]),el(0,0,0,1),new Float32Array([0,0,0,1]),el(0,0,1,0),new Float32Array([0,0,1,0]),el(0,0,1,1),new Float32Array([0,0,1,1]),el(0,1,0,0),new Float32Array([0,1,0,0]),el(0,1,0,1),new Float32Array([0,1,0,1]),el(0,1,1,0),new Float32Array([0,1,1,0]),el(0,1,1,1),new Float32Array([0,1,1,1]),el(1,0,0,0),new Float32Array([1,0,0,0]),el(1,0,0,1),new Float32Array([1,0,0,1]),el(1,0,1,0),new Float32Array([1,0,1,0]),el(1,0,1,1),new Float32Array([1,0,1,1]),el(1,1,0,0),new Float32Array([1,1,0,0]),el(1,1,0,1),new Float32Array([1,1,0,1]),el(1,1,1,0),new Float32Array([1,1,1,0]),el(1,1,1,1),new Float32Array([1,1,1,1]);function $c(e,t,n){return e+(t-e)*n}function el(e,t,n,r){return $c($c(e,t,.75),$c(n,r,.75),.875)}var tl=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),nl=e(((e,t)=>{t.exports=tl()}))(),rl=()=>{let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(!t)throw Error(`2D context not available`);t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height);let n=new It(e);n.minFilter=_,n.magFilter=_,n.generateMipmaps=!1;let r=[],i=null,a=6.4,o=()=>{t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height)},s=e=>{let n={x:e.x*64,y:(1-e.y)*64},r=1;r=e.age<19.2?(e=>Math.sin(e*Math.PI/2))(e.age/19.2):(e=>-e*(e-2))(1-(e.age-19.2)/44.8)||0,r*=e.force;let i=`${(e.vx+1)/2*255}, ${(e.vy+1)/2*255}, ${r*255}`;t.shadowOffsetX=320,t.shadowOffsetY=320,t.shadowBlur=a,t.shadowColor=`rgba(${i},${.22*r})`,t.beginPath(),t.fillStyle=`rgba(255,0,0,1)`,t.arc(n.x-320,n.y-320,a,0,Math.PI*2),t.fill()};return{canvas:e,texture:n,addTouch:e=>{let t=0,n=0,a=0;if(i){let r=e.x-i.x,o=e.y-i.y;if(r===0&&o===0)return;let s=r*r+o*o,c=Math.sqrt(s);n=r/(c||1),a=o/(c||1),t=Math.min(s*1e4,1)}i={x:e.x,y:e.y},r.push({x:e.x,y:e.y,age:0,force:t,vx:n,vy:a})},update:()=>{o();for(let e=r.length-1;e>=0;e--){let t=r[e],n=t.force*.015625*(1-t.age/64);t.x+=t.vx*n,t.y+=t.vy*n,t.age++,t.age>64&&r.splice(e,1)}for(let e=0;e<r.length;e++)s(r[e]);n.needsUpdate=!0},set radiusScale(e){a=6.4*e},get radiusScale(){return a/6.4},size:64}},il=(e,t)=>new Wc(`LiquidEffect`,`
    ...
    `,{uniforms:new Map([[`uTexture`,new ia(e)],[`uStrength`,new ia(t?.strength??.025)],[`uTime`,new ia(0)],[`uFreq`,new ia(t?.freq??4.5)]])}),al={square:0,circle:1,triangle:2,diamond:3},ol=`
void main() {
  gl_Position = vec4(position, 1.0);
}
`,sl=`
...
`,cl=10,ll=({variant:e=`square`,pixelSize:t=3,color:n=`#B497CF`,className:r,style:i,antialias:a=!0,patternScale:o=2,patternDensity:s=1,liquid:c=!1,liquidStrength:u=.1,liquidRadius:d=1,pixelSizeJitter:f=0,enableRipples:p=!0,rippleIntensityScale:m=1,rippleThickness:h=.1,rippleSpeed:g=.3,liquidWobbleSpeed:_=4.5,autoPauseOffscreen:v=!0,speed:y=.5,transparent:b=!0,edgeFade:x=.5,noiseAmount:S=0})=>{let C=(0,l.useRef)(null),w=(0,l.useRef)({visible:!0}),T=(0,l.useRef)(y),E=(0,l.useRef)(null),D=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let r=C.current;if(!r)return;T.current=y;let i=[`antialias`,`liquid`,`noiseAmount`],l={antialias:a,liquid:c,noiseAmount:S},O=!1;if(!E.current)O=!0;else if(D.current){for(let e of i)if(D.current[e]!==l[e]){O=!0;break}}if(O){if(E.current){let e=E.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),E.current=null}let i=new Sc({canvas:document.createElement(`canvas`),antialias:a,alpha:!0,powerPreference:`high-performance`});i.domElement.style.width=`100%`,i.domElement.style.height=`100%`,i.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),r.appendChild(i.domElement),b?i.setClearAlpha(0):i.setClearColor(0,1);let l={uResolution:{value:new U(0,0)},uTime:{value:0},uColor:{value:new wn(n)},uClickPos:{value:Array.from({length:cl},()=>new U(-1,-1))},uClickTimes:{value:new Float32Array(cl)},uShapeType:{value:al[e]??0},uPixelSize:{value:t*i.getPixelRatio()},uScale:{value:o},uDensity:{value:s},uPixelJitter:{value:f},uEnableRipples:{value:+!!p},uRippleSpeed:{value:g},uRippleThickness:{value:h},uRippleIntensity:{value:m},uEdgeFade:{value:x}},y=new En,C=new Vi(-1,1,1,-1,0,1),D=new hi({vertexShader:ol,fragmentShader:sl,uniforms:l,transparent:!0,depthTest:!1,depthWrite:!1,glslVersion:$e}),O=new Ur(new oi(2,2),D);y.add(O);let k=new aa,ee=()=>{let e=r.clientWidth||1,n=r.clientHeight||1;i.setSize(e,n,!1),l.uResolution.value.set(i.domElement.width,i.domElement.height),E.current?.composer&&E.current.composer.setSize(i.domElement.width,i.domElement.height),l.uPixelSize.value=t*i.getPixelRatio()};ee();let te=new ResizeObserver(ee);te.observe(r);let ne=(()=>{if(typeof window<`u`&&window.crypto?.getRandomValues){let e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0]/4294967295}return Math.random()})()*1e3,A,re,j;if(c){re=rl(),re.radiusScale=d,A=new Ic(i);let e=new Gc(y,C);j=il(re.texture,{strength:u,freq:_});let t=new Qc(C,j);t.renderToScreen=!0,A.addPass(e),A.addPass(t)}if(S>0){A||(A=new Ic(i),A.addPass(new Gc(y,C)));let e=new Qc(C,new Wc(`NoiseEffect`,`uniform float uTime; uniform float uAmount; float hash(vec2 p){ return fract(sin(dot(p, vec2(127.1,311.7))) * 43758.5453);} void mainUv(inout vec2 uv){} void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){ float n=hash(floor(uv*vec2(1920.0,1080.0))+floor(uTime*60.0)); float g=(n-0.5)*uAmount; outputColor=inputColor+vec4(vec3(g),0.0);} `,{uniforms:new Map([[`uTime`,new ia(0)],[`uAmount`,new ia(S)]])}));e.renderToScreen=!0,A&&A.passes.length>0&&A.passes.forEach(e=>e.renderToScreen=!1),A.addPass(e)}A&&A.setSize(i.domElement.width,i.domElement.height);let M=e=>{let t=i.domElement.getBoundingClientRect(),n=i.domElement.width/t.width,r=i.domElement.height/t.height;return{fx:(e.clientX-t.left)*n,fy:(t.height-(e.clientY-t.top))*r,w:i.domElement.width,h:i.domElement.height}};i.domElement.addEventListener(`pointerdown`,e=>{let{fx:t,fy:n}=M(e),r=E.current?.clickIx??0;l.uClickPos.value[r].set(t,n),l.uClickTimes.value[r]=l.uTime.value,E.current&&(E.current.clickIx=(r+1)%cl)},{passive:!0}),i.domElement.addEventListener(`pointermove`,e=>{if(!re)return;let{fx:t,fy:n,w:r,h:i}=M(e);re.addTouch({x:t/r,y:n/i})},{passive:!0});let N=0,ie=()=>{if(v&&!w.current.visible){N=requestAnimationFrame(ie);return}l.uTime.value=ne+k.getElapsedTime()*T.current,j&&(j.uniforms.get(`uTime`).value=l.uTime.value),A?(re&&re.update(),A.passes.forEach(e=>{let t=e.effects;t&&t.forEach(e=>{let t=e.uniforms?.get(`uTime`);t&&(t.value=l.uTime.value)})}),A.render()):i.render(y,C),N=requestAnimationFrame(ie)};N=requestAnimationFrame(ie),E.current={renderer:i,scene:y,camera:C,material:D,clock:k,clickIx:0,uniforms:l,resizeObserver:te,raf:N,quad:O,timeOffset:ne,composer:A,touch:re,liquidEffect:j}}else{let r=E.current;if(r.uniforms.uShapeType.value=al[e]??0,r.uniforms.uPixelSize.value=t*r.renderer.getPixelRatio(),r.uniforms.uColor.value.set(n),r.uniforms.uScale.value=o,r.uniforms.uDensity.value=s,r.uniforms.uPixelJitter.value=f,r.uniforms.uEnableRipples.value=+!!p,r.uniforms.uRippleIntensity.value=m,r.uniforms.uRippleThickness.value=h,r.uniforms.uRippleSpeed.value=g,r.uniforms.uEdgeFade.value=x,b?r.renderer.setClearAlpha(0):r.renderer.setClearColor(0,1),r.liquidEffect){let e=r.liquidEffect;e&&(e.value=u);let t=r.liquidEffect.uniforms.get(`uFreq`);t&&(t.value=_)}r.touch&&(r.touch.radiusScale=d)}return D.current=l,()=>{if(E.current&&O||!E.current)return;let e=E.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),E.current=null}},[a,c,S,t,o,s,p,m,h,g,f,x,b,u,d,_,v,e,n,y]),(0,nl.jsx)(`div`,{ref:C,className:`pixel-blast-container ${r??``}`,style:i,"aria-label":`PixelBlast interactive background`})};function ul(){return(0,nl.jsx)(`main`,{className:`content-container`,children:(0,nl.jsxs)(`div`,{style:{width:`100%`,height:`600px`,position:`relative`},children:[(0,nl.jsx)(ll,{variant:`square`,pixelSize:4,color:`#036916`,patternScale:2,patternDensity:1,pixelSizeJitter:0,enableRipples:!0,rippleSpeed:.4,rippleThickness:.12,rippleIntensityScale:1.5,liquid:!1,liquidStrength:.12,liquidRadius:1.2,liquidWobbleSpeed:5,speed:.5,edgeFade:.25,transparent:!0}),(0,nl.jsxs)(`div`,{style:{position:`relative`,zIndex:1},children:[(0,nl.jsx)(`h1`,{children:`Pixel Blast`}),(0,nl.jsx)(`p`,{children:`A retro-modern digital background.`}),(0,nl.jsx)(`button`,{className:`cta-btn`,children:`Explore Studio`})]})]})})}(0,u.createRoot)(document.getElementById(`root`)).render((0,nl.jsx)(l.StrictMode,{children:(0,nl.jsx)(ul,{})}));